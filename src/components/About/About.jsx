    ...
    <div className={styles.About}>
      ...
      <section className={styles.Cards}>
        <div className={styles.Card}> 
          ...
          <a className={styles.Icons} href="https://www.linkedin.com/in/chrisficht/" target="_brel=" rel="noopener noreferrer"><FaLinkedinIn className="social-icon" /></a>
          <a className={styles.Icons} href="https://github.com/cficht" target="_brel=" rel="noopener noreferrer"><FaGithub className="social-icon" /></a>
          </div>
        <div className={styles.Card}>
        ...
        <div className={styles.Card} >
          ...
          <p className={styles.Summary}>Full-stack developer with a particular passion for solving human-facing problems. I thrive in environments where collaboration is key to building elegant and clean projects. I strongly value companies that support career growth and professional development.</p>
          <a className={styles.Icons} href="https://www.linkedin.com/in/hannah-m-riley/" target="_brel=" rel="noopener noreferrer"><FaLinkedinIn className="social-icon" /></a>
          <a className={styles.Icons} href="https://github.com/hannahriley33" target="_brel=" rel="noopener noreferrer"><FaGithub className="social-icon" /></a>
          </div>
        <div className={styles.Card}>
          <img src={josh} className={styles.Avatar}></img>
          <h3 className={styles.Name}>Josh Ford</h3>
          <p className={styles.Summary}>17 year IT veteran who made a big leap into the underground glass art world. Solitary studio environment work drained some of my creative juices and left me wanting more in terms of collaboration. I made another leap of faith back into the tech world, though this time in a more stimulating and challenging role.   </p>
          <a className={styles.Icons} href="https://www.linkedin.com/in/thisisjoshford/" target="_brel=" rel="noopener noreferrer"><FaLinkedinIn className="social-icon" /></a>
          <a className={styles.Icons} href="https://github.com/thisisjoshford" target="_brel=" rel="noopener noreferrer"><FaGithub className="social-icon" /></a>
          </div>
      </section>
    </div>
  )
